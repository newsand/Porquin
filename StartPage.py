...
class StartPage(tk.Frame):
    def __init__(self, master):
        ...
        tk.Button(self, text="Login", command=lambda: master.switch_frame(LoginPage.LoginPage)).pack()
        tk.Button(self, text="Register", command=lambda: master.switch_frame(RegisterPage.RegisterPage)).pack()